...
const CONFIG = {
    botToken: '8214379782:AAHly12Ve2_lPJDI-nUOVMYdRGvmlDBR7uA',
    ownerId: '8152191246',
    adminUserName: '@Michh244',
    groupLink: 'https://t.me/+0LOv5RXed6wwMjFi',
    groupId: '-3805571487',
    botImage: 'https://files.catbox.moe/sjxea8.jpg',
    dbPath: './database',
    batchSize: 10,
    delayPerBatch: 3000,
    maxEmails: 10,
        ...
        if (user.expired === 0 || Date.now() > user.expired) {
            ...
            if (!tempStorage.has(spamKey)) {
                await ctx.reply(`🔴 <b>MASA AKTIF HABIS</b>\n\nID: <code>${uid}</code>\nPaket Anda tidak aktif. Silakan hubungi Admin untuk membeli durasi.`, {
                    ...
                    reply_markup: {
                        inline_keyboard: [
                            [{ text: '📞 Hubungi Admin', url: `https://t.me/Michh244${CONFIG.adminUserName}` }]
                        ]
                    }
                });
...
(async () => {
    console.log('🚀 Yanzy INDONESIA Started...');
